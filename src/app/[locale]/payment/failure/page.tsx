      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8 relative overflow-hidden mt-20 mb-16">
        ...
        <div className="relative flex flex-col items-center justify-center h-auto max-h-[85dvh] w-full max-w-[90%] sm:max-w-md md:max-w-lg bg-[#0D0D0D] border-2 border-[#E57373]/30 rounded-3xl md:rounded-4xl px-4 py-5 md:py-8 text-center shadow-[0_20px_60px_-15px_rgba(229,115,115,0.15)] animate-in zoom-in-95 duration-700 overflow-y-auto scrollbar-hide">
          ...
          <div className="relative mb-3 inline-block">
            <div className="absolute inset-0 bg-[#E57373]/20 rounded-full blur-xl animate-pulse" />
            <div className="relative w-12 h-12 md:w-16 md:h-16 bg-[#1A1A1A] border-2 border-[#E57373] rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(229,115,115,0.3)]">
              <svg viewBox="0 0 24 24" className="w-6 h-6 md:w-8 md:h-8 text-[#E57373] animate-in slide-in-from-bottom-2 duration-700" fill="none" stroke="currentColor" strokeWidth="3">
          ...
          {/* Content */}
          <h1 className="text-lg sm:text-xl md:text-2xl text-[#E57373] font-serif tracking-widest uppercase mb-1 [text-shadow:0_0_15px_rgba(229,115,115,0.3)] px-2">
            {t("title")}
          </h1>
          ...
          <div className="w-10 md:w-16 h-0.5 bg-[#E57373]/30 mx-auto mb-2 md:mb-4 rounded-full" />
          ...
          <Link
            href={`/${locale}`}
            className="group relative inline-flex items-center justify-center gap-3 px-8 md:px-10 py-3 md:py-3.5 bg-[#E57373] text-white rounded-full font-bold text-xs md:text-sm uppercase tracking-wider transition-all hover:bg-[#C62828] hover:scale-105 active:scale-95 shadow-[0_10px_30px_-5px_rgba(229,115,115,0.4)]"
          >
            <span>{t("button")}</span>
