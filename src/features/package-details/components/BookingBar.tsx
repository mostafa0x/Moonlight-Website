...
function BookingBar({ price, currency, packageId }: BookingBarProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 w-full bg-black/80 backdrop-blur-md border-t border-white/10 pb-[env(safe-area-inset-bottom)] shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
