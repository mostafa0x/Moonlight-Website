    ...
    <div className="absolute inset-0 w-full h-full overflow-hidden">
      ...
      <div className="relative h-full w-full flex flex-col justify-end px-6 md:px-12 lg:px-24 pb-12 lg:pb-32 z-20">
        <div className="max-w-5xl">
          ...
          <h2 className="font-cairo text-5xl md:text-8xl lg:text-[10rem] font-black text-white mb-6 lg:mb-10 uppercase leading-[0.85] tracking-tighter bg-linear-to-b from-white via-white to-white/40 bg-clip-text [text-shadow:0_20px_50px_rgba(0,0,0,0.5)]">
            {item.title}
          </h2>
