...
export default function TestimonialsSection() {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center px-10 md:px-10 font-jakarta select-none">
            <div className="w-full max-w-[1100px] max-h-[90vh] md:max-h-[75vh] bg-zinc-800/50 rounded-[32px] px-5 py-4 md:px-8 md:pt-2 md:pb-8 border border-white/5 backdrop-blur-sm flex flex-col gap-4 md:gap-6 overflow-y-auto scrollbar-hide">
                {/* Header Section */}
                <div className="flex flex-col items-center text-center gap-1 md:gap-1.5">
                    ...
                    <p className="text-[10px] md:text-sm text-emerald-50 md:text-gray-200 max-w-[300px] md:max-w-[600px]">
                ...
                <div className="flex flex-col lg:flex-row   items-stretch w-full min-h-0">
                    ...
                    <div className="relative flex-1 min-h-[260px] md:min-h-[320px] bg-zinc-800 rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-lg overflow-hidden flex flex-col">
                        {/* Card Top Meta */}
                ...
                {/* TripAdvisor Partner Badge */}
                <div className="w-full inline-flex justify-center items-start pt-[20px] md:pt-[41px]">
                    <div className="px-5 py-3 bg-color-white-solid rounded-2xl shadow-[0px_12px_32px_0px_rgba(15,23,42,0.12)] flex justify-start items-center gap-3">
                        <div className="relative w-14 h-14 bg-neutral-100 rounded-[19px] overflow-hidden p-1">
                            <img
                        ...
                        <div className="flex flex-col">
                            <div className="flex flex-col leading-tight">
                                ...
                                <div className="flex items-center gap-1">
                                    <span className="text-color-grey-53 text-base font-normal leading-5 md:leading-7">{t("rating")}/5 </span>
