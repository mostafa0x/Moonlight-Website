...
export default function TestimonialsSection() {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center px-10 md:px-10 font-jakarta select-none">
            <div className="w-full max-w-275 max-h-[90vh] md:max-h-[75vh] bg-zinc-800/50 rounded-4xl px-5 py-4 md:px-8 md:pt-2 md:pb-8 border border-white/5 backdrop-blur-sm flex flex-col gap-4 md:gap-6 overflow-y-auto scrollbar-hide">
                {/* Header Section */}
                ...
                <div className="w-full inline-flex justify-center items-start pt-5 md:pt-10.25">
