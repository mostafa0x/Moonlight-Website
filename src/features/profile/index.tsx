...
export const ProfileFeature: React.FC = () => {
  ...
  const { bookings, isLoading: bookingsLoading, cancelBooking, isCancelling } = useProfileBookings();
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:px-10">
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
            ...
            <div className="text-center md:text-right flex flex-col gap-2">
              <h1 className="text-4xl font-bold font-cairo uppercase">
                {userName || "USER"}
              </h1>
              <p className="text-slate-400 text-lg font-normal font-cairo">
                {userEmail}
              </p>
              {/* Sign Out (Mobile) */}
              <button
              ...
              >
                ...
                <span className="text-white text-sm font-normal font-cairo">Sign Out</span>
              </button>
            </div>
          </div>
          ...
          <div className="hidden md:flex flex-col gap-4">
            ...
            >
              <img src={"/icons/sign-out.svg"} alt="sign out" />
              <span className="text-white text-xl font-normal font-cairo">Sign Out</span>
            </button>
            <div className="text-center text-slate-500 text-sm italic">
              {/* Secondary or Status indicator if needed */}
            </div>
          </div>
        </div>
