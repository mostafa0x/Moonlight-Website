  ...
  return (
    <div className="flex flex-col items-center justify-center h-full min-h-[400px] w-full bg-black/90 backdrop-blur-md rounded-[20px] overflow-hidden relative select-none">
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="absolute w-32 h-32 border-[1px] border-t-[#F2C975] border-r-transparent border-b-[#F2C975]/20 border-l-transparent rounded-full animate-spin [animation-duration:4s]" />
        <div className="absolute w-36 h-36 border-[1px] border-t-transparent border-r-[#F2C975]/40 border-b-transparent border-l-[#F2C975]/40 rounded-full animate-reverse-spin [animation-duration:3s]" />
      ...
      <div className="mt-12 text-center z-10">
        ...
        <div className="flex gap-3 justify-center mt-6">
          {[0, 1, 2].map((i) => (
            <div
              key={i}
              className="w-2 h-2 bg-gradient-to-b from-[#F2C975] to-[#8C6D2E] rounded-full animate-bounce shadow-[0_0_5px_#F2C975]"
