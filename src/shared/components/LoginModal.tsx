  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 opacity-[0.04] select-none pointer-events-none grid grid-cols-4 gap-4 p-8 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#F2C975] to-transparent opacity-50" />
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <p className="text-[#A1A1A1] mb-2 text-sm tracking-[0.1em] font-medium uppercase italic">
            {t("secureVoyage")}
          </p>
          <div className="w-12 h-0.5 bg-[#F2C975]/40 mb-8 rounded-full" />
          
          <p className="text-[#8B8B8B] mb-10 text-base leading-relaxed max-w-[280px]">
            {t("loginDescription")}
          </p>
          ...
          >
            {/* Hover Glow Effect */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#F2C975]/0 via-[#F2C975]/5 to-[#F2C975]/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700" />
